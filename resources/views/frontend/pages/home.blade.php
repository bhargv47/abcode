...
<main class="content-2">
	...
	<section id="home" class="home d-flex align-items-center">
		<div class="container">
			...
			<div class="intro">
				<!-- avatar image -->
				<img src="{{ asset('public/frontend/images/avatar-1.svg') }}" alt="Bolby" class="mb-4" />

				<!-- info -->
				<h1 class="mb-2 mt-0">Bhargav B.</h1>
				<span>I'm a <span class="">Web Developer.</span></span>
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="text-center text-md-left">
						<!-- avatar image -->
						<img src="{{ asset('public/frontend/images/avatar-2.svg') }}" alt="Bolby" />
					</div>
				...
				<div class="col-md-9 triangle-left-md triangle-top-sm">
					<div class="rounded bg-white shadow-dark padding-30">
						<div class="row">
							<div class="col-md-6">
								<!-- about text -->
								<p>I am Bhargav, Web Developer and Designer. I have rich experience in web site design and building and customization. My background as a Web Developer, along with my education in Computer Science, have allowed me to attain a strong foundation of technical skills. I have been in this field from around 4+ years working as a web developer, designer and funnel expert.</p>
								<div class="mt-3">
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="service-box rounded data-background padding-30 text-center text-light shadow-blue" data-color="#6C6CE5">
						<img src="{{ asset('public/frontend/images/service-1.svg') }}" alt="UI/UX design" />
				...
				<div class="col-md-4">
					...
					<div class="service-box rounded data-background padding-30 text-center shadow-yellow" data-color="#F9D74C">
						<img src="{{ asset('public/frontend/images/service-2.svg') }}" alt="UI/UX design" />
				...
				<div class="col-md-4">
					...
					<div class="service-box rounded data-background padding-30 text-center text-light shadow-pink" data-color="#F97B8B">
						<img src="{{ asset('public/frontend/images/service-3.svg') }}" alt="UI/UX design" />
		...
		<div class="container">
			...
			<div class="row portfolio-wrapper">
				...
				<div class="col-md-4 col-sm-6 grid-item art">
					<a href="{{ asset('public/frontend/images/works/1.svg') }}" class="work-image">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="{{ asset('public/frontend/images/works/1.svg') }}" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4 col-sm-6 grid-item creative design">
					<a href="#small-dialog" class="work-content">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="{{ asset('public/frontend/images/works/2.svg') }}" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
					<div id="small-dialog" class="white-popup zoom-anim-dialog mfp-hide">
						<img src="{{ asset('public/frontend/images/single-work.svg') }}" alt="Title" />
				...
				<div class="col-md-4 col-sm-6 grid-item branding">
					<a href="https://www.youtube.com/watch?v=qf9z4ulfmYw" class="work-video">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="{{ asset('public/frontend/images/works/3.svg') }}" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4 col-sm-6 grid-item creative">
					<a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/240233494&amp;color=%23ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true&amp;visual=true" class="work-video">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="{{ asset('public/frontend/images/works/4.svg') }}" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4 col-sm-6 grid-item art branding">
					<a href="#gallery-1" class="gallery-link">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="{{ asset('public/frontend/images/works/5.svg') }}" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
					<div id="gallery-1" class="gallery mfp-hide">
						<a href="{{ asset('public/frontend/images/works/5.svg') }}"></a>
						<a href="{{ asset('public/frontend/images/works/4.svg') }}"></a>
					</div>
				</div>
				...
				<div class="col-md-4 col-sm-6 grid-item creative design">
					<a href="https://themeforest.net/user/pxlsolutions/portfolio" target="_blank">
						<div class="portfolio-item rounded shadow-dark">
							...
							<div class="thumb">
								<img src="{{ asset('public/frontend/images/works/6.svg') }}" alt="Portfolio-title" />
								<div class="mask"></div>
							</div>
						</div>
					</a>
			...
			<div class="testimonials-wrapper">
				...
				<div class="testimonial-item text-center mx-auto">
					<div class="thumb mb-3 mx-auto">
						<img src="{{ asset('public/frontend/images/avatar-3.svg') }}" alt="customer-name" />						
					</div>
				...
				<div class="testimonial-item text-center mx-auto">
					<div class="thumb mb-3 mx-auto">
						<img src="{{ asset('public/frontend/images/avatar-1.svg') }}" alt="customer-name" />						
					</div>
					<h4 class="mt-3 mb-0">John Doe</h4>
					<span class="subtitle">Product designer at Dribbble</span>
					<div class="bg-white padding-30 shadow-dark rounded triangle-top position-relative mt-4">
			...
			<div class="row">
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="{{ asset('public/frontend/images/client-1.svg') }}" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="{{ asset('public/frontend/images/client-2.svg') }}" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="{{ asset('public/frontend/images/client-3.svg') }}" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="{{ asset('public/frontend/images/client-4.svg') }}" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="{{ asset('public/frontend/images/client-5.svg') }}" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="{{ asset('public/frontend/images/client-6.svg') }}" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="{{ asset('public/frontend/images/client-7.svg') }}" alt="client-name" />
						</div>
					</div>
				</div>
				<div class="col-md-3 col-6">
					...
					<div class="client-item">
						<div class="inner">
							<img src="{{ asset('public/frontend/images/client-8.svg') }}" alt="client-name" />
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<form id="contact-form" class="contact-form mt-6" method="post" action="https://pxltheme.com/html/bolby/demo/form/contact.php">
						@csrf
						<div class="messages">
							<div class="alert alert-danger" id="error"> Something Wrong </div>
							<div class="alert alert-success" id="success">Thanks for contact us! We will contact you soon...</div>
						</div>
